export type ConfigureGitHubRepositoryInput = {
  ...
  SERVER_AUTH_REFRESH_COOKIE_PATH: string;
  SERVER_AUTH_REFRESH_COOKIE_SAME_SITE: string;
  SERVER_AUTH_REFRESH_COOKIE_SECURE: string;
  SERVER_AUTH_REFRESH_TOKEN_TRANSPORT: string;
