...
export function resolveConfigureGitHubRepositoryInput(
  ...
  return {
    ...
    SERVER_AUTH_REFRESH_COOKIE_PATH: requiredText(
      input.SERVER_AUTH_REFRESH_COOKIE_PATH,
      "SERVER_AUTH_REFRESH_COOKIE_PATH",
    ),
    SERVER_AUTH_REFRESH_COOKIE_SAME_SITE: requiredText(
      input.SERVER_AUTH_REFRESH_COOKIE_SAME_SITE,
      "SERVER_AUTH_REFRESH_COOKIE_SAME_SITE",
    ),
    SERVER_AUTH_REFRESH_COOKIE_SECURE: requiredText(
      input.SERVER_AUTH_REFRESH_COOKIE_SECURE,
      "SERVER_AUTH_REFRESH_COOKIE_SECURE",
    ),
    SERVER_AUTH_REFRESH_TOKEN_TRANSPORT: requiredText(
      input.SERVER_AUTH_REFRESH_TOKEN_TRANSPORT,
      "SERVER_AUTH_REFRESH_TOKEN_TRANSPORT",
    ),
