  ...
  it("sets the expected repository variables and secrets", async () => {
    ...
    assert.deepEqual(
      ...
      [
        ...
        "variable:SERVER_AUTH_REFRESH_TOKEN_TRANSPORT:cookie",
        "variable:SERVER_AUTH_REFRESH_COOKIE_SECURE:true",
        "variable:SERVER_AUTH_REFRESH_COOKIE_SAME_SITE:none",
        "variable:SERVER_AUTH_REFRESH_COOKIE_PATH:/graphql",
