...
if (eventName === "pull_request") {
  ...
  writeOutput("release_targets_json", "[]");
...
const serverAffectedProjects = serverBaseSha
  ? rushAffectedProjects(serverBaseSha)
  : [];
const webappAffectedProjects = webappBaseSha
  ? rushAffectedProjects(webappBaseSha)
  : [];
...
writeOutput("validate_targets_json", JSON.stringify(deployTargets));
writeOutput("release_targets_json", JSON.stringify(deployTargets));
