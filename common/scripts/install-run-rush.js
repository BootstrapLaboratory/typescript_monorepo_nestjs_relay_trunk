...
/******/ (() => {
  ...
  \**********************************************************/
    ...
    function _getRushVersion(logger) {
      ...
      const rushJsonPath = node_path__WEBPACK_IMPORTED_MODULE_0__.join(
        rushJsonFolder,
        RUSH_JSON_FILENAME,
      );
      try {
        const rushJsonContents =
          node_fs__WEBPACK_IMPORTED_MODULE_1__.readFileSync(
            rushJsonPath,
            "utf-8",
          );
    ...
    function _run() {
      ...
      const scriptName =
        node_path__WEBPACK_IMPORTED_MODULE_0__.basename(scriptPath);
